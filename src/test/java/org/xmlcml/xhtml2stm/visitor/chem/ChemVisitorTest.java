...
public class ChemVisitorTest {
	...
	/*@Test
	public void testSVGVisitable2() throws Exception {
		SVGVisitable svgVisitable = new SVGVisitable();
		svgVisitable.addSVGElement(SVGElement.readAndCreateSVG(new File("C:/workspace/xhtml2stm-dev/target/output/metabolites-02-00039/image.g.2.10.svg")));
		
		ChemVisitor chemVisitor = new ChemVisitor();
		chemVisitor.visit(svgVisitable);
		SVGUtil.debug(chemVisitor.getMolecules().get(0), "C:/workspace/xhtml2stm-dev/target/output/metabolites-02-00039/image.g.2.10.svg.new2.cml", 0);
	}*/
