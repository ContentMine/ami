...
public class Fixtures {
	...
	public static final File XHTML2STM_DIR = new File(TEST_RESOURCES_DIR, "org/xmlcml/xhtml2stm/");
	...
	public static File GROUPS_CML = new File(MAIN_RESOURCES_DIR, "org/xmlcml/xhtml2stm/visitor/chem/groups.cml");
	
	// FIGURES
	public static final File FIGURE_DIR = new File(TEST_RESOURCES_DIR, "org/xmlcml/xhtml2stm/figures");
	...
	// OUTPUT
	public static final File TEST_DIRECTORIES_DIR = new File(TEST_RESOURCES_DIR, "org/xmlcml/xhtml2stm/directories");
	
	// REGEX
	public static final File MAIN_REGEX_DIR = new File(MAIN_RESOURCES_DIR, "org/xmlcml/xhtml2stm/regex");
	public static final File TEST_REGEX_DIR = new File(TEST_RESOURCES_DIR, "org/xmlcml/xhtml2stm/regex");
	...
	// TREE
	public static final File TREE_DIR = new File(TEST_RESOURCES_DIR, "org/xmlcml/xhtml2stm/tree");
