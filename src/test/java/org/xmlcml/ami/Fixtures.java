...
public class Fixtures {
	...
	public static final File TEST_AMI_DIR = new File(TEST_RESOURCES_DIR, "org/xmlcml/ami/");
	//CHEM
	public static final File FROM_NORMA_DIR = new File(TEST_AMI_DIR, "fromNorma");
	
	//CHEM
	public static final File MOLECULES_DIR = new File(TEST_AMI_DIR, "molecules");
	...
	public static File WEDGES = new File(TEST_AMI_DIR, "wedges.svg");
	public static File WEDGESREDUCED = new File(TEST_AMI_DIR, "wedgesreduced.svg");
	public static File ARROWHEADS = new File(TEST_AMI_DIR, "arrowheads.svg");
	public static File THICKLINES = new File(TEST_AMI_DIR, "thicklines.svg");
	public static File THICKLINESREDUCED = new File(TEST_AMI_DIR, "thicklinesreduced.svg");
	...
	// FIGURES
	public static final File FIGURE_DIR = new File(TEST_AMI_DIR, "figures");
	...
	public static final File IMAGES_DIR = new File(TEST_AMI_DIR, "images");
	...
	// HTML
	public static final File HTML_DIR = new File(TEST_AMI_DIR, "html");
	...
	// XML
	public static final File XML_DIR = new File(TEST_AMI_DIR, "xml");
	public static final File PLOSONE_0080753_XML = new File(XML_DIR, "journal.pone.0080753.xml");
	
	// MATERIALS/SPECTRA
	public static final File MATERIALS_DIR = new File(TEST_AMI_DIR, "materials");

	// OUTPUT
	public static final File TEST_DIRECTORIES_DIR = new File(TEST_AMI_DIR, "directories");
	...
	// SEQUENCE
	public static final File SEQUENCE_DIR = new File(TEST_AMI_DIR, "sequences");

	// SPECIES
	public static final File SPECIES_DIR = new File(TEST_AMI_DIR, "species");
//	public static final File MULTIPLE_SPECIES_312_HTML = new File(SPECIES_DIR, "multiple.species.312.html");
	...
	// TREE
	public static final File TREE_DIR = new File(TEST_AMI_DIR, "tree");
	...
	//PLOSONE
	public static final File PLOSONE_DIR = new File(TEST_AMI_DIR, "plosone");
	...
	// LOCAL PDFS
	public static final File XHTML_PDF_DIR = new File(TEST_AMI_DIR, "pdf");
